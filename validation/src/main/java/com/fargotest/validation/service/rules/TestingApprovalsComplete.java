...
public class TestingApprovalsComplete implements RuleInterface {
    
    @Override
    public Mono<RuleResult> process(Validation validation, ApplicationReference application,  ValidationRule validationRule) {
        log.info("Processing rule TestingApprovalsComplete for application {}", application.getApplicationId());
