...
public class RegulatoryCompliancePass implements RuleInterface {
    
    @Override
    public Mono<RuleResult> process(Validation validation, ApplicationReference application,  ValidationRule validationRule) {
        log.info("Processing rule RegulatoryCompliancePass for application {}", application.getApplicationId());
